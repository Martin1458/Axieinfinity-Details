...
class AxieDetails:
    ...
    @staticmethod
    def getAxieDetails():
        global tableAxieDetails, auction, name, priceUSD
    ...
    def defineTable():
        ...
        l02 = [tableAxieDetails.json()['data']['axie']['name']]  # name
        l03 = [str(AxieId)]  # id
        l04 = [str(priceUSD)]  # price
        l05 = [str(tableAxieDetails.json()['data']['axie']['level'])]  # level
        l06 = [str(tableAxieDetails.json()['data']['axie']['stats']['hp'])]  # hp
        l07 = [str(tableAxieDetails.json()['data']['axie']['stats']['skill'])]  # skill
        l08 = [str(tableAxieDetails.json()['data']['axie']['stats']['speed'])]  # speed
        l09 = [str(tableAxieDetails.json()['data']['axie']['stats']['morale'])]  # morale
        l10 = [str(tableAxieDetails.json()['data']['axie']['breedCount'])]  # breedCount
        l11 = [str(tableAxieDetails.json()['data']['axie']['stage'])]  # stage
        l12 = [str(tableAxieDetails.json()['data']['axie']['title'])]  # title
        l13 = [str(tableAxieDetails.json()['data']['axie']['bodyShape'])]  # bodyShape
        l14 = [str(datetime.utcfromtimestamp(tableAxieDetails.json()['data']['axie']['birthDate']).strftime('%Y-%m-%d %H:%M:%S'))]  # birthDate
        l15 = [str(tableAxieDetails.json()['data']['axie']['class'])]  # class
        l16 = []  # Eyes
        l17 = []  # Ears
        l18 = []  # Back
        l19 = []  # Mouth
        ...
        if tableAxieDetails.json()['data']['axie']['parts'] != []:
            for i in range(len(tableAxieDetails.json()['data']['axie']['parts'])):
                try:
                    if "id" in tableAxieDetails.json()['data']['axie']['parts'][i]['abilities'][0]:
                        if i == 0:
                            l16 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id']) + ' : ' + str(tableAxieDetails.json()['data']['axie']['parts'][i]['abilities'][0]['id'])]
                        if i == 1:
                            l17 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id']) + ' : ' + str(tableAxieDetails.json()['data']['axie']['parts'][i]['abilities'][0]['id'])]
                        if i == 2:
                            l18 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id']) + ' : ' + str(tableAxieDetails.json()['data']['axie']['parts'][i]['abilities'][0]['id'])]
                        if i == 3:
                            l19 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id']) + ' : ' + str(tableAxieDetails.json()['data']['axie']['parts'][i]['abilities'][0]['id'])]
                        if i == 4:
                            l20 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id']) + ' : ' + str(tableAxieDetails.json()['data']['axie']['parts'][i]['abilities'][0]['id'])]
                        if i == 5:
                            l21 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id']) + ' : ' + str(tableAxieDetails.json()['data']['axie']['parts'][i]['abilities'][0]['id'])]

                except:
                    if i == 0:
                        l16 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id'])]
                    if i == 1:
                        l17 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id'])]
                    if i == 2:
                        l18 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id'])]
                    if i == 3:
                        l19 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id'])]
                    if i == 4:
                        l20 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id'])]
                    if i == 5:
                        l21 = [str(tableAxieDetails.json()['data']['axie']['parts'][i]['id'])]
